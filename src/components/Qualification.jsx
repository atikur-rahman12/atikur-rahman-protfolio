...
export default function Qualification() {
  const qualifications = [
    ...
    },
    {
      ...
      year: "2026 - Present",
      desc: "Building responsive websites using React.js, Next.js, Tailwind CSS and modern UI animations.",
    ...
    },
    {
      ...
      place: "Self Learning Journey | PH",
      year: "2026 - Present",
      desc: "Creating REST APIs, authentication systems, MongoDB databases, and deployment workflows.",
      icon: <Briefcase size={26} />,
